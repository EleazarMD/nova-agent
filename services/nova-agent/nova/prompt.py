...
def build_system_prompt(
    ...
    if tool_names:
        sections.append(
            ...
            "- hub_delegate → ALL specialized tasks (research, analytics, communications, browser, infrastructure, code, vehicle)\n"
            "- openclaw_delegate → LEGACY ONLY (being replaced by hub_delegate + Argus for browser tasks)\n"
            "- Direct tools → quick lookups, single email/calendar reads, weather, lights, memory (no delegation needed)\n\n"
            "**Approval tiers**:\n"
