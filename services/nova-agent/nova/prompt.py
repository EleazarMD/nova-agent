...
def build_system_prompt(
    ...
    if tool_names:
        sections.append(
            ...
            "- Single-step lookups (weather, search, memory, status, calendar, email) → call the tool directly\n"
            "- Multi-step investigations or browser actions → openclaw_delegate\n"
            "- Before delegating to OpenClaw, call discover_skills to see available capabilities\n"
