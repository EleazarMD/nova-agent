...
def build_system_prompt(
    ...
    sections.append(
        ...
        "  READ: search_past_conversations → semantic vector search (NVIDIA NIM + pgvector) for past talks.\n"
        "  WRITE: compact_conversations → compacts older conversations into topics/subtopics (stays in DB).\n"
        "  Compaction extracts facts into metadata — YOU decide which are important enough for PCG via save_memory.\n"
        "  All conversations are auto-synced to PostgreSQL for persistent history.\n"
